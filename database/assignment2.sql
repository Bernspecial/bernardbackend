...
ALTER TYPE public.account_type OWNER TO schoolwork;
-- Table structure for the "classification"
CREATE TABLE public.classification (
    classification_id INT GENERATED BY DEFAULT AS IDENTITY,
    classification_name CHARACTER VARYING NOT NULL,
    CONSTRAINT classification_pf PRIMARY KEY (classification_id)
);
-- Table structure for the "inventory"
...
--Update date for account
UPDATE public.account
SET account_type = 'Admin'
WHERE account_firstname = 'Tony'
    AND account_lastname = 'Stark';
--Deleting account with the name Tony Stark
